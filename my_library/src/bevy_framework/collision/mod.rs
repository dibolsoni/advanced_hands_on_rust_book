...
mod rect2d;
mod static_quadtree;
use crate::bevy_framework::physics::PhysicsPosition;
...
pub fn check_collisions<A, B>(
    ...
    mut sender: MessageWriter<OnCollision<A, B>>,
) where
    A: Component,
    B: Component,
{
    ...
    query_b.iter().for_each(
        |(entity, transform, bbox): (Entity, &PhysicsPosition, &AxisAlignedBoundingBox)| {
    ...
    query_a.iter().for_each(
        |(entity_a, transform_a, bbox_a): (Entity, &PhysicsPosition, &AxisAlignedBoundingBox)| {
